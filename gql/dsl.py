...
class DSLDirective:
    ...
    def __init__(self, name: str, dsl_schema: "DSLSchema", **kwargs: Any):
        ...
        if directive_def is None:
            ...
            for builtin_directive in specified_directives:
                if builtin_directive.name == name:
        ...
        if not any(loc in executable_locations for loc in directive_def.locations):
            raise GraphQLError(
                f"Directive '@{name}' is not executable. "
                f"It can only be used in type system locations, not in queries."
            )
    ...
    def args(self, **kwargs: Any) -> "DSLDirective":
        """Add arguments to the directive.
        ...
        # Validate and convert all arguments
        arguments = []
        ...
        # Update AST directive with new arguments
    ...
    def directives(self, *directives: DSLDirective) -> Any:
        ...
        for directive in directives:
            ...
            if not self.is_valid_directive(directive):
                ...
                valid_locations = [
                    loc.name for loc in directive.directive_def.locations 
                    if loc in {
                        DirectiveLocation.QUERY,
                        DirectiveLocation.MUTATION,
                        DirectiveLocation.SUBSCRIPTION,
...
class DSLVariable(DSLDirectable):
    ...
    def is_valid_directive(self, directive: "DSLDirective") -> bool:
        ...
        return DirectiveLocation.VARIABLE_DEFINITION in directive.directive_def.locations
...
class DSLFragment(DSLSelectable, DSLFragmentSelector, DSLExecutable):
    ...
    def is_valid_directive(self, directive: "DSLDirective") -> bool:
        ...
        return DirectiveLocation.FRAGMENT_DEFINITION in directive.directive_def.locations
